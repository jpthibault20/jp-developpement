              ...
              <div className="card lg:card-side bg-[#faf3f3] shadow-xl">
                ...
                <div className="card-body">
                  ...
                  <div className={`${item.actif ? 'card-actions justify-end' : 'hidden'}`}>
                    ...
                    <Button variant="ghost" className="bg-[#4f46e5] text-[#dde3ff] drop-shadow-xl rounded-2xl w-[150] hover:bg-[#151335] hover:text-white" onClick={() => setIsOpen(true)} tabIndex={0} aria-label="Contactez-nous">
                      contact
                    </Button>
                  </div>
                </div>
